...
a7 = plot(usd_imp_inflation_rate{:, 1}, zeros(size(usd_imp_inflation_rate, 1), 1) + ...
    mean(mean(usd_imp_inflation_rate{:, 2:end}, 2)), 'LineWidth', ...
    2, 'LineStyle', '--', 'color', 'red', 'DisplayName', 'Implied Anchor Rate');
a8 = plot(usd_imp_inflation_rate{:, 1}, zeros(size(usd_imp_inflation_rate, 1), 1) + ...
    mean(beta1{1:85, 2}), 'LineWidth', 2, 'LineStyle', '--', 'color', ...
    'blue', 'DisplayName', 'Realized Anchor Rate');
